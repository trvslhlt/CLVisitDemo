...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func setupLocationDelegate() {
    self.locationDelegate = LocationDelegate.sharedInstance
    locationDelegate?.monitorVisits(true)
    locationDelegate?.monitorSignificantLocationChanges(true)
  }
